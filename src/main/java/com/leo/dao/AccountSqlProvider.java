...
import com.leo.domain.AccountParam.Criteria;
import com.leo.domain.AccountParam.Criterion;
...
public class AccountSqlProvider {
     ...
     */
    public String countByExample(AccountParam example) {
        SQL sql = new SQL();
     ...
     * @mbg.generated Wed Apr 29 10:35:51 CST 2020
     */
    public String deleteByExample(AccountParam example) {
        SQL sql = new SQL();
     ...
     * @mbg.generated Wed Apr 29 10:35:51 CST 2020
     */
    public String selectByExample(AccountParam example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        AccountParam example = (AccountParam) parameter.get("example");
     ...
     * @mbg.generated Wed Apr 29 10:35:51 CST 2020
     */
    protected void applyWhere(SQL sql, AccountParam example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
