...
import com.leo.domain.RoleExample.Criteria;
import com.leo.domain.RoleExample.Criterion;
...
public class RoleSqlProvider {
    ...
    public String insertSelective(Role record) {
        ...
        if (record.getSeqid() != null) {
            sql.VALUES("seqid", "#{seqid,jdbcType=BIGINT}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getSeqid() != null) {
            sql.SET("seqid = #{record.seqid,jdbcType=BIGINT}");
        }
    ...
    public String updateByPrimaryKeySelective(Role record) {
        ...
        sql.WHERE("seqid = #{seqid,jdbcType=BIGINT}");
